...
def config_exception_handlers():
    # definir funçoes para lidar com as excepçoes HTTPUnauthorizedAccess,
    # HTTPUnauthorizedOnly e 404
    ...
    # app.add_exception_handler(Excepcao_A, funcao_trata_de_A)
    app.add_exception_handler(HTTPUnauthorizedAccess,
                              unauthorized_access_handler)
    app.add_exception_handler(
        status.HTTP_404_NOT_FOUND, unauthorized_access_handler)
    app.add_exception_handler(HTTPUnauthenticatedOnly,
